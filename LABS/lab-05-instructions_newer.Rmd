...
An R Markdown template that organizes all of the instruction’s code and a template for answering each question is available for you to download in our lab templates iCollege folder. 
